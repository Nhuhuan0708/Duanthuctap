...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/wogomin/public/css/user/huan/news.css">
              ...
              <div class="row row-content-news">
               <div class="col-sm-10">
                  <div class="row justify-content-start">
                      <div class="col-sm-4">
                          <div class="news">
                              <img id="img-news" src="/wogomin/public/images/user/huan/giaoducconcai.jpg" style="width:100%">
                          </div>
                      </div>
                      <div class="col-sm-4">
                  ...
                  <div class="row row-news-1">
                    <div class="col-sm-4 col-news">
                      <img id="img-news-1" src="/wogomin/public/images/user/huan/giaoducconcai.jpg" style="width:40%">
                      <a href="#" id="a-news-1"><p id="p-news-1">Thiết lập nề nếp gia đình</p></a>
                      <p id="date-news-1">29/10/2020</p>
                    </div>
                    <div class="col-sm-4 col-news">
                      <img id="img-news-2" src="/wogomin/public/images/user/huan/giaoducconcai.jpg" style="width:40%">
                      <a href="#" id="a-news-1"><p id="p-news-1">Thiết lập nề nếp gia đình</p></a>
                      <p id="date-news-1">29/10/2020</p>
                    </div>
                    <div class="col-sm-4 col-news">
