<nav class="navbar navbar-expand-lg navbar-light">
  ...
  <div class="mx-auto">
  <a class="nav-link" href="./homepage"><img src="/wogomin/public/images/user/huan/WoGoMin_W.png" style="width:150px"></a>
  </div>
  ...
  <div class=" navbar-ul-1 collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav ">
      ...
      <li class="nav-item nav-avt" id="nav-item-1">
        <a class="nav-link" href="./profile"><img id="icavt" src="/wogomin/public/images/user/huan/avt.jpg"></a>
      </li>
      <li class="nav-item">
